                    ...
                    <table class="w-full min-w-[320px] text-sm">
                      ...
                      <tbody class="divide-y divide-default">
                        ...
                        <tr v-if="!call.positions.length">
                          <td colspan="3" class="px-3 py-2 text-sm text-muted text-center italic">No positions</td>
                        </tr>
                      </tbody>
                      <tfoot>
